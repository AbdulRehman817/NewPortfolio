...
export default function BrutalistPortfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ['Next.js', 'TypeScript', 'MongoDB', 'Tailwind CSS', 'Auth.js'],
      shortDesc: 'Responsive with CRUD & auth',
      overview: 'A responsive e-commerce store built with Next.js and TypeScript, featuring full product CRUD operations and a secure authentication system powered by Auth.js.',
      features: ['TypeScript for type safety across frontend and backend', 'Server-side rendering with Next.js', 'Complete product CRUD with image upload', 'JWT authentication via Auth.js', 'Mongoose schemas with validation'],
      github: 'https://github.com/AbdulRehman817/Shopping-Store',
      live: 'https://shopping-store-frontend-chi.vercel.app/',
      year: '2023',
      type: 'E-Commerce',
    },
    {
